...
public class MessageManager {
    ...
    public void sendMessageToPlayer(Player player, String messageKey) {
        sendMessage(player, getMessage(messageKey, PalutenBoss.getInstance().getLoader().getLanguage()));
    }
    ...
    public void sendTitleToPlayer(Player player, String messageKey) {
        player.sendTitle(getMessage(messageKey, PalutenBoss.getInstance().getLoader().getLanguage()), "");
    }
    ...
    public void sendNoPlayerMessage() {
        Bukkit.getConsoleSender().sendMessage(PalutenBoss.getInstance().getPrefix() + getMessage("noPlayer", PalutenBoss.getInstance().getLoader().getLanguage()));
    }
